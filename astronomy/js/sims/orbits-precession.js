...
// successive perihelia − 2π) and shown next to Einstein's first-order formula
...
import { label } from '../engine/sketch.js';
import { slider, buttonRow, actionButton, setReadout } from '../engine/controls.js';
import { rk4, binetDeriv } from '../engine/integrators.js';
import {
  G, C2, M_SUN, M_SGRA, YEAR, ARCSEC_PER_RAD, schwarzschildRadius, fmtNum, sci,
...
export class OrbitsSim extends Sim {
  init() {
    this.buildControls();
