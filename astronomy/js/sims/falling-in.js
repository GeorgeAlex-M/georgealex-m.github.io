...
(() => {
  ...
  const {
    Sim, opts, COLORS, label, stickFigure, doodleClock, doodleArrow, notToScale,
    buttonRow, actionButton, setReadout,
    G, C, M_SUN, M_SGRA, schwarzschildRadius, fmtTime, fmtLen, sci, fmtNum,
  } = A;
  ...
  class FallingInSim extends Sim {
    init() {
    ...
    render() {
      ...
      if (!compact) {
        ...
        // Bob himself, watching from a safe distance
  ...
  A.register('fallingIn', FallingInSim);
})();
