...
import { COLORS, FONT_HAND } from './palette.js';
import { opts } from './rough-helpers.js';
...
export function stickFigure(rc, x, y, {
  scale = 1,
  stretch = 1,
  seed = 7,
  color = COLORS.ink,
...
export function doodleArrow(rc, x1, y1, x2, y2, { color = COLORS.ink, seed = 11, strokeWidth = 1.8 } = {}) {
...
export function notToScale(rc, ctx, x, y, seed = 5) {
  const w = 116;
  const h = 26;
...
export function doodleClock(rc, ctx, x, y, r, t, { color = COLORS.ink, seed = 21, caption = '' } = {}) {
...
export function sparkle(rc, x, y, s, { color = COLORS.ink, seed = 31 } = {}) {
