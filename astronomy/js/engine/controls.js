...
(() => {
  ...
  function buttonRow(parent, defs, { initial, onSelect = () => {} } = {}) {
  ...
  function actionButton(parent, text, onclick) {
  ...
  Object.assign(A, { slider, buttonRow, actionButton, setReadout });
})();
